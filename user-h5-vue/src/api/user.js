...
export function GetFavoritePage(pageNo, pageSize) {
  return request({
    url: '/shop-api/users/favorite/page',
    method: 'get',
...
export function DelFavorite(spuId) {
  return request({
    url: '/shop-api/users/favorite/remove',
    method: 'DELETE',
    params: {spuId}
  })
}
...
export function hasUserSpuFavorite(spuId) {
  return request({
    url: '/shop-api/users/favorite/hasUserFavorite',
    method: 'get',
    params: {spuId}
  })
}
...
export function updateUserNickname(nickname) {
  return request({
    url: '/shop-api/user/update-nickname',
    method: 'post',
    params: {
      nickname,
    }
...
export function passportLoginBySms(mobile, code) {
  return request({
    url: '/shop-api/passport/login-by-sms',
    method: 'post',
    params: {
      mobile,
      code,
...
export function passportSendSmsCode(mobile, scene) {
  return request({
    url: '/shop-api/passport/send-sms-code',
    method: 'post',
    params: {
      mobile,
      scene
...
export function listUserAddressList() {
  return request({
    url: '/shop-api/user-address/list',
    method: 'get',
  })
}
...
export function getDefaultAddress() {
  return request({
    url: '/shop-api/user-address/get-default',
    method: 'get',
  })
}
...
export function updateUserAddress(data) {
  return request({
    url: '/shop-api/user-address/update',
    method: 'POST',
    params: data
  })
}
...
export function createUserAddress(data) {
  return request({
    url: '/shop-api/user-address/create',
    method: 'POST',
    params: data
  })
}
...
export function deleteUserAddress(userAddressId) {
  return request({
    url: '/shop-api/user-address/delete',
    method: 'POST',
    params: {userAddressId}
  })
}
