...
export const asyncRoutes = [
  {
    ...
    children: [
      {
        path: 'page',
        component: () => import('@/views/deleted/permission/page'),
        name: 'PagePermission',
        meta: {
      ...
      {
        path: 'directive',
        component: () => import('@/views/deleted/permission/directive'),
      ...
      {
        path: 'role',
        component: () => import('@/views/deleted/permission/role'),
        name: 'RolePermission',
        meta: {
  ...
  //       name: '资源管理',
  //       meta: { title: '资源管理', icon: 'clipboard' }
  //     }
  //   ]
  // },
  {
...
/**
 * 基于从服务端获得的菜单树，构建基于菜单的动态路由
 *
 * @param menus 菜单树
 * @returns {[]} 动态路由
 */
export function generateMenuRoutes(menus) {
  const res = []
  menus.forEach(menu => {
    const tmp = {
      name: menu.name,
