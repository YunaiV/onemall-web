<template>
	<div class="app-container">
		<!--搜索栏 -->
		<el-form :model="adminListQuery" ref="adminListQueryForm" :inline="true">
		...
		<!-- 管理员列表的分页 -->
		<pagination :total="adminListTotal" :page.sync="adminListQuery.pageNo" :limit.sync="adminListQuery.pageSize"
								v-show="adminListTotal > 0" @pagination="getAdminList"/>

		<!-- 管理员添加与修改表单 -->
		<el-dialog :title="adminFormTitle" :visible.sync="adminFormVisible" width="600px" append-to-body
							 v-loading="adminFormLoading" element-loading-text="提交中..." element-loading-spinner="el-icon-loading">
		...
		<!-- 管理员授权表单 -->
		<el-dialog title="分配角色" :visible.sync="assignAdminRoleFormVisible" width="600px" append-to-body
							 v-loading="assignAdminRoleFormLoading" element-loading-text="提交中..." element-loading-spinner="el-icon-loading">
...
import { listAllRole } from '@/api/permission/role'
import { listAdminRoles, assignAdminRole } from '@/api/permission/permission'

import Pagination from '@/components/Pagination'

import { AdminTypeEnum } from '@/utils/constants'
